  ...
  useEffect(() => {
    ...
    if (currentResult?.boundingBoxes && currentResult.boundingBoxes.length > 0) {
      currentResult.boundingBoxes.forEach((box) => {
        ...
        ctx.fillRect(x - 2, y - 2, cSize, 3);
        ctx.fillRect(x - 2, y - 2, 3, cSize);
        ctx.fillRect(x + width - cSize + 2, y - 2, cSize, 3);
        ctx.fillRect(x + width - 2, y - 2, 3, cSize);
        ctx.fillRect(x - 2, y + height - 2, cSize, 3);
        ctx.fillRect(x - 2, y + height - cSize + 2, 3, cSize);
        ctx.fillRect(x + width - cSize + 2, y + height - 2, cSize, 3);
        ctx.fillRect(x + width - 2, y + height - cSize + 2, 3, cSize);
